        ...
        <div className="login__content">
            <div className="login__box">
              ...
              <div className="login__box-input">
                <input type="email" value={email} id="email" name="email" onChange={(e) => setEmail(e.target.value)} required className="login__input"/>
            ...
            <div className="login__box">
              ...
              <div className="login__box-input">
                <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} id="password" name="password" required className="login__input"/>
